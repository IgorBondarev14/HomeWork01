...
public class HW01 {
    ...
    public static void randInt() {
        ...
        i = new Random().nextInt(-1000, 1001);
    ...
    public static void maxByte(int num) {
        ...
        int number = Integer.highestOneBit(Math.abs(num));
    ...
    public static void notdivisible() {
        ...
        int m2[] = new int[count_notdivisible];
        int count = 0;
        ...
        for (int l = 1; l < m2.length ; l++) {
            if (l == m2.length - 1) {
                System.out.println(m2[l - 1] + "]");
                break;
            }
            System.out.print(m2[l - 1] + ", ");
            if (l % 25 == 0) {
                System.out.println();
            }
        }
